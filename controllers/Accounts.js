...
module.exports = class Accounts extends BaseController {
    ...
    update(callback) {
        ...
        const senders = getUniqueAccounts(store.accountTransactions, store.transactionFees, 'SenderAccountAddress');
        const recipients = getUniqueAccounts(store.accountTransactions, store.transactionFees, 'RecipientAccountAddress');
        ...
        function getUniqueAccounts(arr, arr1, uniqueBy) {
            const results = arr
            ...
            const accounts = results
                ...
                .map(i => {
                    return {
                        ...
                        TotalFeesPaid: i.TotalFeesPaid,
                        TotalFeesPaidConversion: null,
                        BlockHeight: i.BlockHeight,
                    };
                });

            accounts.TotalFeesPaid = accounts.TotalFeesPaid + fee.Fee
            return accounts;
        }
    }
};